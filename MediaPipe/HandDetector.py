    ...
    if results.multi_hand_landmarks:
        for handType, handLms in zip(results.multi_handedness, results.multi_hand_landmarks):
            ...
            for lm in handLms.landmark:
                point = (WIDTH - int(lm.x * WIDTH),HEIGHT - int(lm.y * HEIGHT), abs(int(lm.z*2500)))
...
webcam1.start()
#webcam2 = WebcamStream(2,WIDTH,HEIGHT) 
#webcam2.start()
...
while True:
    ...
    if(len(leftHand1) != 0):
        point1 = (leftHand1[0],leftHand1[1],leftHand1[5])
        point2 = (leftHand1[15],leftHand1[16],leftHand1[17])
        z = GetDepthMono(point1,point2)
        depth_track.append(leftHand1[5])
        i += 1
...
print("num iter:", j)
print("Max:", depth_track[78])
print("3rd:", depth_track[59])
print("Mean:", depth_track[39])
print("1st:", depth_track[19])
print("Min:", depth_track[0])
